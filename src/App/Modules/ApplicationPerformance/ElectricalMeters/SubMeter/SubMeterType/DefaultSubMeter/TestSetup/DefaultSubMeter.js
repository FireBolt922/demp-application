...
const verifyDefaultSubMeter = () => {
  it('Verify the default sub meter.', async (done) => {
    ...
    // Expand the ht meter list to see all sub meters.
    await expect(page).toClick('a', { text: 'Sub Meter 1 Default' });
  ...
  it('Verify the History Form in Default Sub Meter', async (done) => {
