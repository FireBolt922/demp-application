...
export function getSubMeterInfo(plantID, meterID) {
  return http.get(API_ENDPOINTS.SUB_METER_DATA(plantID, meterID));
}
export function graphDataService(meterId, params, page) {
  ...
  return http.get(
    `${API_ENDPOINTS.SUB_METER_DATA_GRAPH}/${meterId}/graph`,
    queryParam,
  );
}
